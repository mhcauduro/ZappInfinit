...
class MainWindow(wx.Frame):
    ...
    def _on_about(self, event=None):
        ...
        info = "\n".join(
            ...
            for line in (
                "Desenvolvido e mantido por: Matheus Cauduro.",
                "Design de acessibilidade e UX: Kyara Silva.",
                "",
                "Site: https://matheuscauduro.com.br",
                "WhatsApp: 11942023508",
                "",
    ...
    def _run_sync(self):
        ...
        # following minutes, and nothing pushes it to ZappInfinit when it lands. So
    ...
    def _backfill_empty_chats(self):
        ...
        the history-sync queue. Nothing pushes decoded history to ZappInfinit:
    ...
    # get-messages then reports faithfully, so from ZappInfinit's side the sync
    ...
    #
    # There is nothing ZappInfinit can do about it at runtime, so these two
    ...
    def log_history_sync_status(self, context: str = "") -> dict | None:
        ...
        if bridge_ready is False:
            logging.error(
                ...
                "not a ZappInfinit sync bug.", stored_msgs, stored_chats,
            )
    ...
    def unblock_history_sync(self, timeout: int = 60) -> dict | None:
        ...
        anywhere. ZappInfinit used to create that state itself, from
    ...
    def delete_message_for_me(self, remote_jid: str, msg_key: dict) -> bool:
        ...
        "Delete for me" only ever removed the message from ZappInfinit's own
