"""
ZappInfinit System Tray Icon
------------------------
Manages the notification-area icon that persists while ZappInfinit is running,
...
class TrayIcon(wx.adv.TaskBarIcon):
    """Persistent system-tray icon for ZappInfinit."""
    ...
    def _load_icon(self):
        """Try to load ZappInfinit.ico; fall back to a generated 'W' bitmap."""
        for candidate in [
            resource_path("ZappInfinit.ico"),
            resource_path("data", "ZappInfinit.ico"),
        ]:
    ...
    def _build_tooltip(self, total, names):
        ...
        Build a tooltip like:
          'ZappInfinit | sincronizando | 35 mensagens não lidas de mãe, jogos'
          'ZappInfinit | 1 mensagem não lida de mãe'
          'ZappInfinit | nenhuma mensagem não lida'
